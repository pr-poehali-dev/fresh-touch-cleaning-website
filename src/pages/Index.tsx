  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <a href="#gallery" className="text-slate-700 hover:text-blue-600 transition-colors">Наши работы</a>
            <a href="#testimonials" className="text-slate-700 hover:text-blue-600 transition-colors">Отзывы</a>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-lg text-blue-100">
              Вернем вашей мебели и коврам первозданный вид. Качественно, быстро, с гарантией результата.
            </p>
            ...
            {[
              {
                ...
                description: "Диваны, кресла, стулья, матрасы, пуфы и другая мягкая мебель."
              },
              {
                icon: "RugRoll",
                title: "Химчистка ковров",
                description: "Ковры любых размеров, ковровые покрытия, ковролин, ковровая плитка."
              },
              {
                icon: "Car",
                title: "Химчистка салона авто",
                description: "Сиденья, потолок, двери, коврики и багажное отделение."
              }
            ].map((service, index) => (
              <Card key={index} className="hover:-translate-y-1 transition-transform duration-300">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  <div className="bg-blue-100 p-4 rounded-full mb-4">
                    <Icon name={service.icon} className="h-8 w-8 text-blue-600" />
                  </div>
      ...
      <section id="gallery" className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-blue-900">До и После</h2>
          ...
          <Tabs defaultValue="furniture" className="w-full">
            ...
            <TabsContent value="furniture" className="w-full">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    before: "https://images.unsplash.com/photo-1558211662-a7fd206d67e7?q=80&w=500",
                    after: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?q=80&w=500"
                  },
                  {
                    before: "https://images.unsplash.com/photo-1540574163026-643ea20ade25?q=80&w=500",
                    after: "https://images.unsplash.com/photo-1560185007-5f0bb1866cab?q=80&w=500"
                  }
                ].map((item, index) => (
                  <div key={index} className="relative rounded-lg overflow-hidden group h-72">
                    <img src={item.before} alt="До химчистки" className="absolute inset-0 w-full h-full object-cover transition-opacity group-hover:opacity-0" />
                    <img src={item.after} alt="После химчистки" className="absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity group-hover:opacity-100" />
            ...
            <TabsContent value="carpets">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    before: "https://images.unsplash.com/photo-1603793303277-ed67787545e5?q=80&w=500",
                    after: "https://images.unsplash.com/photo-1615971677499-5467cbab01c0?q=80&w=500"
                  },
                  {
                    before: "https://images.unsplash.com/photo-1595428774223-ef52624120d2?q=80&w=500",
                    after: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?q=80&w=500"
                  }
                ].map((item, index) => (
                  <div key={index} className="relative rounded-lg overflow-hidden group h-72">
            ...
            <TabsContent value="car">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    before: "https://images.unsplash.com/photo-1597007066704-67bf2068d5b2?q=80&w=500",
                    after: "https://images.unsplash.com/photo-1601362840469-51e4d8d58785?q=80&w=500"
                  },
                  {
                    before: "https://images.unsplash.com/photo-1552083375-1447ce886485?q=80&w=500",
                    after: "https://images.unsplash.com/photo-1627531937355-87dd7adbdf12?q=80&w=500"
                  }
                ].map((item, index) => (
                  <div key={index} className="relative rounded-lg overflow-hidden group h-72">
                    <img src={item.before} alt="До химчистки" className="absolute inset-0 w-full h-full object-cover transition-opacity group-hover:opacity-0" />
            ...
            {[
              {
                ...
                description: "Сроки выполнения от 2 часов, в зависимости от объема работ"
              },
              {
                icon: "ShieldCheck",
                title: "Безопасные средства",
                description: "Используем только сертифицированную экологичную химию"
              },
              {
                icon: "Award",
              ...
              },
              {
                ...
                description: "Наличный и безналичный расчет, оплата после выполнения работ"
              }
            ].map((advantage, index) => (
              <div key={index} className="flex flex-col items-center text-center">
                <div className="bg-blue-800 p-4 rounded-full mb-4">
                  <Icon name={advantage.icon} className="h-8 w-8 text-blue-200" />
                </div>
      ...
      <section id="testimonials" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-blue-900">Отзывы клиентов</h2>
      ...
      <section id="prices" className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-blue-900">Стоимость услуг</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4 text-blue-800">Химчистка мебели</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4 text-blue-800">Химчистка ковров</h3>
                <ul className="space-y-3">
                  <li className="flex justify-between items-center border-b pb-2">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4 text-blue-800">Химчистка авто</h3>
                <ul className="space-y-3">
                  <li className="flex justify-between items-center border-b pb-2">
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-600 mb-4">Точная стоимость услуг зависит от состояния изделия, сложности загрязнений и объема работ.</p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-blue-900">Наше оборудование и средства</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-slate-700 mb-4">
                Мы используем только профессиональное оборудование ведущих производителей, которое эффективно удаляет загрязнения, не повреждая обрабатываемую поверхность:
              </p>
            ...
            <div>
              ...
              <p className="text-slate-700 mb-4">
                В работе мы применяем только сертифицированные чистящие средства, которые эффективно справляются с загрязнениями и безопасны для людей и животных:
              </p>
              <ul className="space-y-2">
                {[
      ...
      <section id="about" className="py-20 bg-blue-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-6 text-blue-900">О компании FreshTouch</h2>
              <p className="text-slate-700 mb-4">
                Компания FreshTouch специализируется на профессиональной химчистке мягкой мебели, ковров и салонов автомобилей уже более 5 лет. За это время мы обслужили более 3000 клиентов и получили сотни положительных отзывов.
              </p>
              <p className="text-slate-700 mb-4">
                Наша команда состоит из опытных специалистов, которые регулярно проходят обучение новейшим методикам чистки. Мы постоянно совершенствуемся, обновляем оборудование и расширяем спектр используемых профессиональных средств.
              </p>
              <p className="text-slate-700">
                Наша миссия — делать жизнь наших клиентов чище, уютнее и комфортнее. Мы ценим доверие клиентов и стремимся полностью оправдать их ожидания.
              </p>
            </div>
            <div className="md:w-1/2">
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Готовы вернуть чистоту вашему дому?</h2>
          <p className="text-blue-200 mb-8 max-w-2xl mx-auto">
            Закажите химчистку прямо сейчас и получите скидку 10% на первый заказ. Мы ответим на все ваши вопросы и подберем оптимальное решение.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p>Профессиональная химчистка мягкой мебели и ковровых покрытий. Работаем с любыми видами загрязнений.</p>
            </div>
            
            <div>
              <h3 className="text-white font-semibold mb-4">Услуги</h3>
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-blue-400 transition-colors">Химчистка диванов</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Химчистка ковров</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Химчистка матрасов</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors">Химчистка автомобилей</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <Icon name="Phone" className="mr-2 h-5 w-5 text-blue-400 shrink-0" />
                  <span>+7 (900) 123-45-67</span>
                </li>
                <li className="flex items-start">
                  <Icon name="Mail" className="mr-2 h-5 w-5 text-blue-400 shrink-0" />
                  <span>info@freshtouch.ru</span>
                </li>
                <li className="flex items-start">
                  <Icon name="MapPin" className="mr-2 h-5 w-5 text-blue-400 shrink-0" />
